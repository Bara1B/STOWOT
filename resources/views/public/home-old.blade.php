...
{{-- No extra CSS needed; styles are bundled via Vite app.css --}}
...
@section('content')
    <div class="relative min-h-screen">
        ...
        <!-- Hero Section -->
        <div class="hero-section relative z-10 pt-16 pb-20 px-4 sm:px-6 lg:px-8 shadow-2xl">
        ...
        <div class="relative z-10 py-16 px-4 sm:px-6 lg:px-8 fade-in">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" id="statistics-section">
                    ...
                    <!-- Pending Work Orders -->
                    <div class="stats-card initial-fade-in initial-stagger-3 fade-in">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div
                    ...
                    <div class="stats-card initial-fade-in initial-stagger-4 fade-in">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div
                    ...
                    <!-- Overdue Work Orders -->
                    <div class="stats-card initial-fade-in initial-stagger-5 fade-in">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div
