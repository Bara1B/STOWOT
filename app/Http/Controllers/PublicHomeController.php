...
class PublicHomeController extends Controller
{
    public function index()
    {
        ...
        return view('public.home', compact(
            ...
            'latestWorkOrder',
            'monthlyWoAccepted'
        ))->with('monthlyWoData', $monthlyWoAccepted);
    }
    ...
    public function workOrders(Request $request)
    {
        ...
        $workOrders = $query->orderBy('created_at', 'desc')->paginate(9);
        ...
        // Get latest work order for navigation
        $latestWorkOrder = WorkOrder::latest()->first();

        return view('public.work-orders', compact('workOrders', 'statusOptions', 'filters', 'latestWorkOrder'));
    }
}
