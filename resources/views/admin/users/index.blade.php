...
@section('content')
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('admin.settings.users.create') }}" class="btn btn-primary">➕ Tambah User Baru</a>
        </div>
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.settings.users.edit', $user) }}" class="btn btn-sm btn-outline-warning"
                                            title="Edit">✏️</a>
