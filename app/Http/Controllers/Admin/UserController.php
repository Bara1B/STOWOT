...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.settings.users')->with('success', 'User baru berhasil dibuat.');
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect()->route('admin.settings.users')->with('success', 'Data user berhasil di-update.');
    }
    ...
    public function destroy(User $user)
    {
        ...
        $user->delete();
        return redirect()->route('admin.settings.users')->with('success', 'User berhasil dihapus.');
    }
}
